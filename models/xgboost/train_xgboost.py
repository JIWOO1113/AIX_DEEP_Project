...
report_df.to_csv("xgb_per_class_results.csv", encoding="utf-8-sig")

cm = confusion_matrix(y_test, test_pred)
cm_df = pd.DataFrame(cm, index=target_names, columns=target_names)
cm_df.to_csv("xgb_confusion_matrix.csv", encoding="utf-8-sig")

best_model.save_model("xgb_checkpoint.json")
